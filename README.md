This fork is intended for a specific purpose with a specific project. It is not recommended for use by others.
...
```
source 'https://github.com/Aurnax/SignalR-Swift.git'
platform :ios, '9.0'

pod 'SignalRSwift', :git => 'https://github.com/Aurnax/SignalR-Swift.git'
 ```
